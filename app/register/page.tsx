...
const RegisterPage: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-100 bg-[url('/bg-svg-f.svg')] bg-cover bg-no-repeat">
      <div className="container mx-auto py-8 flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="form-wrapper bg-white shadow-[17px_17px_34px_#d0d0d0] rounded-2xl p-8 md:p-12 w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center md:mr-4">
          ...
          <p className="mb-4 text-center text-gray-700">
            ...
            <Link href="/login" className="text-[#ff8500] hover:underline px-1">
              Sign In
            </Link>
          </p>
          <RegistorForm />
          <p className="text-center mt-4 text-sm text-gray-700">
            {" "}
            {/* Added text-gray-700 */}I agree to the{" "}
            <Link href="#" className="text-[#ff8500] hover:underline px-0.5">
              Privacy Policy
            </Link>{" "}
            and{" "}
            <Link href="#" className="text-[#ff8500] hover:underline px-0.5">
          ...
          <Link
            href="/login"
            className="text-[#ff8500] hover:underline text-center mt-3"
          >
            Already have an account?
          </Link>
        </div>
        ...
        <div className="login-right-side container w-full md:w-1/2 lg:w-2/5 md:ml-4 mt-8 md:mt-0">
          ...
          <p className="text-gray-700 text-base leading-relaxed mb-6">
            {" "}
            {/* Adjusted text color */}
            If you're ready to engage with a community of individuals committed
            to learning, growing, and supporting each other, we encourage you to
            take the first step by joining our network today.
          </p>
